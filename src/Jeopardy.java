...
public class Jeopardy implements ActionListener {
	...
	private void start() {
		...
		JPanel panel = createHeader("Movies"); 
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if(buttonPressed == firstButton){
			askQuestion("Who plays Jack in Titanic?", "Leonardo Dicaprio", 200); 
		}
		...
		askQuestion("What later Star Wars acctress had an early role in the movie Léon: The Professional?", "Natalie Portman", 400);
		
	}
	
		if(buttonPressed == thirdButton){
		
		askQuestion("Robin Williams won an Academy Award for best supporting actor in which 1997 film about a South Boston janitor?", "Good Will Hunting", 600);
