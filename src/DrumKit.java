...
public class DrumKit extends MouseAdapter {
 ...
 private void getGoing() throws MalformedURLException {
	 ...
	 frame.setTitle("What does the ____ say?");
	 ...
	 String cow = "rubber_cow.jpg";
	 drumLabelWithImage2 = createLabelImage(cow);
 ...
 public void mouseClicked(MouseEvent e) {
	 ...
	 if(drumLabelWithImage.equals(drumClicked)){
	    playSound("realduck.wav");
	 }else if(drumLabelWithImage2.equals(drumClicked)){
		playSound("cow.wav");
	 }
